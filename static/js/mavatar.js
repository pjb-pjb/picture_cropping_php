...
(function (global) {
    ...
    Mavatar.prototype = {
        _init: function (option) {
            ...
            function onPan(ev) {
                self.transform.translate = {x: self.START_X + ev.deltaX, y: self.START_Y + ev.deltaY};
                requestElementUpdate()
            }
            ...
            this.START_X = 0;
            this.START_Y = 0;
            this.transform = {translate: {x: 0, y: 0}, scale: 1, angle: 0, rx: 0, ry: 0, rz: 0};
            var MavatarRender = document.getElementById("Mavatar-render");
            ...
            reader.onload = function (event) {
                ...
                image.onload = function () {
                    ...
                    EXIF.getData(image, function () {
                        ...
                        var rotateCanvas = document.createElement("canvas"), rotateCtx = rotateCanvas.getContext("2d");
                        switch (orientation) {
                            case 1:
